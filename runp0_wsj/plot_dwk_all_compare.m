...
dwk_omega=real(omega).*((omega-2)./(omega-1)+omega.*log(1-1./omega));


dwk_omegastar=(1/3 +1/2*omega +omega.^2+omega.^3 .*log(1-1./omega));
dwk_omegastar=0.0605*dwk_omegastar;
dwk_omega=-0.01*dwk_omega;
