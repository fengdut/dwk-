...
void dwkfuncation(MKL_INT *m, MKL_INT *n, double *x, double *f)
{
	f[0] =x[0]*x[0]*x[0] +x[0] +1;
	return;
}
...
int testsolver()
{
    ...
    /* precisions for stop-criteria (see manual for more details) */
     double eps[6]={0.00001,0.00001,0.00001,0.00001,0.00001,0.00001}; /* set precisions for stop-criteria */
